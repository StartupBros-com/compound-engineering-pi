...
If not installed, inform the user: "`agent-browser` is not installed. Tell the user to run `/ce-setup` next in the current Pi session; do not launch it automatically from this workflow for the current install command, then install agent-browser and retry." Then stop — this skill cannot function without agent-browser.
...
If not installed, inform the user: "`agent-browser` is not installed. Tell the user to run `/ce-setup` next in the current Pi session; do not launch it automatically from this workflow for the current install command, then install agent-browser and retry." Then stop.
